...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="This function allow you to generate a classification result in bar chart, and save it into matplotlib or javascript format.")
    parser.add_argument("-qml", help="path to the qml file which link the class and their color (mandatory)",
                        dest="qmlFile", required=True)
    ...
    parser.add_argument("-results", help="path to the file containing classification's results (mandatory)",
                        dest="resulats", required=True)
