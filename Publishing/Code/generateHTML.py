...
\n\
    ...
    for i in range(len(Allfig_id)):
        file_HTML.write(
            "\t\t\t<tr><td ><input type=checkbox name=ckb value=" + str(i + 1) + " onClick=\"chkcontrol(" + str(
                i + 1) + ",'" + Allfig_id[i] + "')\"></td><td >" + AllTitle[i] + "</td></tr>\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="This function generate a html page, representing classifications describe by a configuration file")
