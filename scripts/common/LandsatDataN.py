...
def TempRes(imageSeries, maskSeries, outputSeries, compPerDate, interpType, inDatelist, outDatelist):
    if (os.path.exists(imageSeries) and os.path.exists(maskSeries)):
        command = "otbcli_ImageTimeSeriesGapFilling -in " + imageSeries + " -mask " + maskSeries + " -out " + outputSeries + " -comp " + str(
            compPerDate) + " -it linear -id " + inDatelist + " -od " + outDatelist
        print command
        os.system(command)
    else:
    ...
    for feature in indices:
        ...
        if feature == "NDVI":
            for date in dlist:
                ...
                expr = "\"(im1b" + str(nir) + "==-10000?-10000:(abs(im1b" + str(nir) + "+im1b" + str(r) \
                       + ")<0.000001?0:(im1b" + str(nir) + "-im1b" + str(r) + ")/(im1b" + str(nir) + "+im1b" + str(
                    r) + ")))\""
        ...
        if feature == "NDWI":
            for date in dlist:
                ...
                expr = "\"(im1b" + str(nir) + "==-10000?-10000:(abs(im1b" + str(swir) + "+im1b" + str(nir) \
                       + ")<0.000001?0:(im1b" + str(swir) + "-im1b" + str(nir) + ")/(im1b" + str(swir) + "+im1b" + str(
                    nir) + ")))\""
                FeatureExt = "otbcli_BandMath -il " + imSerie + " -out " + opath + "/" + feature + "/" + oname + " " + pixelo + " -exp " + expr
                os.system(FeatureExt)
        ...
        if feature == "Brightness":
            for date in dlist:
                ...
                # OTB 5.0
                expr = "\"(im1b" + str(g) + "==-10000?-10000:sqrt((im1b" + str(a) + " * im1b" + str(
                    a) + " )+(im1b" + str(b) + " * im1b" + str(b) \
                       + ")+(im1b" + str(g) + " * im1b" + str(g) + ") + (im1b" + str(r) + " * im1b" + str(
                    r) + ") + (im1b" + str(nir) + " * im1b" + str(nir) \
                       + ") + (im1b" + str(swir) + " * im1b" + str(swir) + ")+(im1b" + str(swir2) + " * im1b" + str(
                    swir2) + ")))\""
                print expr
                FeatureExt = "otbcli_BandMath -il " + imSerie + " -out " + opath + "/" + feature + "/" + oname + " " + pixelo + " -exp " + expr
                print FeatureExt
