...
class iota_testSeq(unittest.TestCase):
    ...
    def test_regionShape(self):
        ...
        same = checkSameGroundTruth([reg_ref, reg_test], [self.imRefRef, self.imRefTest], self.regionField,
                                    tmpPath=self.tmpDir)
        self.assertTrue(same)
    ...
    def test_sameGroundTruth_D0007H0003(self):
        ...
        same = checkSameGroundTruth([shpRef, shpTest], [self.imRefRef, self.imRefTest], self.dataField,
                                    tmpPath=self.tmpDir)
        self.assertTrue(same)
