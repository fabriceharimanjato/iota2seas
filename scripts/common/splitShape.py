...
def split_All_shape(shape, folds, pathConf, pathWd):
    ...
    if pathWd != None:
        for NewShape in createdShape:
            fu.cpShapeFile(NewShape.replace(".shp", ""), outputpath + "/dataAppVal", [".prj", ".shp", ".dbf", ".shx"],
                           spe=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-config", help="path to the configuration file which describe the learning method (mandatory)",
